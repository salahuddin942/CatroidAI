...
import org.catrobat.catroid.ObjectDetection;
...
public class ProjectActivity extends BaseCastActivity {
	...
	public void handleAddSpriteButton() {
		...
		root.findViewById(R.id.dialog_ObjectTracking).setOnClickListener(view -> {
			Intent i = new Intent(this, ObjectDetection.class);
			startActivity(i);
			alertDialog.dismiss();
		});
		alertDialog.show();
